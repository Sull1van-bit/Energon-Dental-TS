...
const Products = () => {
  ...
  const { filteredProducts, availableBrands, productsByCategory } = useMemo(() => {
    if (!productsData) return { filteredProducts: [], availableBrands: [], productsByCategory: {} };
          ...
          <>
            ...
            {Object.keys(productsByCategory).length > 0 ? (
              Object.entries(productsByCategory).map(([category, products], categoryIndex) => {
                const isExpanded = expandedBrands.has(category);
